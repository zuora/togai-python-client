...
class BulkRateCardOperationsRequest(BaseModel):
    """
    Bulk rate card operations for price plan
    """ # noqa: E501
    operations: List[RateCardOperation]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "operations": [RateCardOperation.from_dict(_item) for _item in obj["operations"]] if obj.get("operations") is not None else None
        })
        return _obj

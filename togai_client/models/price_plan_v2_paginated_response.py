...
class PricePlanV2PaginatedResponse(BaseModel):
    """
    Paginated response for price plan
    """ # noqa: E501
    data: List[PricePlanV2]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [PricePlanV2.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,

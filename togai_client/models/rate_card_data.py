...
class RateCardData(BaseModel):
    ...
    type: RateCardType
    display_name: Optional[Annotated[str, Field(strict=True, max_length=255)]] = Field(default=None, description="Display name of the rate card", alias="displayName")
    ...
    __properties: ClassVar[List[str]] = ["billableId", "type", "displayName", "invoiceTiming", "rateCardDetails", "tag"]

...
class Credit(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["accountId", "purpose", "applicableEntityIds", "effectiveFrom", "effectiveUntil", "creditAmount", "priority", "grantorId", "idempotencyKey", "id", "customerId", "status", "creditUnit", "holdAmount", "consumedAmount", "createdAt", "updatedAt"]

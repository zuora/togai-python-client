...
class CalculateRevenueResponseV2(BaseModel):
    """
    CalculateRevenueResponseV2
    """ # noqa: E501
    currency: StrictStr
    usage_lookup_range: Optional[UsageLookupRange] = Field(default=None, alias="usageLookupRange")
    revenue_info: List[RevenueInfoV2] = Field(alias="revenueInfo")
    __properties: ClassVar[List[str]] = ["currency", "usageLookupRange", "revenueInfo"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "revenueInfo": [RevenueInfoV2.from_dict(_item) for _item in obj["revenueInfo"]] if obj.get("revenueInfo") is not None else None
        })
        return _obj

...
class UsageRateCard(BaseModel):
    ...
    UsageRateCard
    """ # noqa: E501
    display_name: Optional[StrictStr] = Field(default=None, description="Name your rate card, this will be displayed in the Togai App", alias="displayName")
    ...
    tag: Optional[StrictStr] = Field(default=None, description="A tag string to group usageRateCards")
    ...
    __properties: ClassVar[List[str]] = ["displayName", "name", "tag", "usageMeterId", "ratePlan", "rateValues"]

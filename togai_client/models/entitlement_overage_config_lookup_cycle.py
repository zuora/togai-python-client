...
class EntitlementOverageConfigLookupCycle(BaseModel):
    """
    Billing cycle of entitlement overages to be looked up, this will be considered if mode is LOOKUP_CYCLE
    """ # noqa: E501
    billing_cycle_end_date: datetime = Field(description="Effective date of the cycle, will be used to get the license entries of the cycle", alias="billingCycleEndDate")
    account_id: Annotated[str, Field(min_length=1, strict=True)] = Field(alias="accountId")
    __properties: ClassVar[List[str]] = ["billingCycleEndDate", "accountId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "billingCycleEndDate": obj.get("billingCycleEndDate"),

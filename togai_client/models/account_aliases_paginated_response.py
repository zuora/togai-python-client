...
class AccountAliasesPaginatedResponse(BaseModel):
    """
    Paginated response for account aliases
    """ # noqa: E501
    data: List[AccountAlias]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [AccountAlias.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,

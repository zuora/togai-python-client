...
class InvoiceDetailsOrganization(BaseModel):
    """
    InvoiceDetailsOrganization
    """ # noqa: E501
    business_name: StrictStr = Field(alias="businessName")
    address: Address
    primary_email: StrictStr = Field(alias="primaryEmail")
    metadata: Optional[Dict[str, StrictStr]] = None
    __properties: ClassVar[List[str]] = ["businessName", "address", "primaryEmail", "metadata"]

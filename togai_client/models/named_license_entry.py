...
class NamedLicenseEntry(BaseModel):
    """
    NamedLicenseEntry
    """ # noqa: E501
    license_id: Annotated[str, Field(min_length=1, strict=True)] = Field(alias="licenseId")
    name: StrictInt
    ...
    __properties: ClassVar[List[str]] = ["licenseId", "name", "effectiveFrom", "effectiveUntil"]

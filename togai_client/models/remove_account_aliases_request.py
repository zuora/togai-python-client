...
class RemoveAccountAliasesRequest(BaseModel):
    """
    Payload to remove account aliases
    """ # noqa: E501
    aliases: Optional[List[StrictStr]] = None
    account_aliases: Optional[List[RemoveAccountAliasRequest]] = Field(default=None, alias="accountAliases")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "accountAliases": [RemoveAccountAliasRequest.from_dict(_item) for _item in obj["accountAliases"]] if obj.get("accountAliases") is not None else None
        })
        return _obj

...
class EditPricingScheduleRequest(BaseModel):
    """
    Request to dis/associate one or more schedules to an account
    """ # noqa: E501
    edits: Annotated[List[UpdatePricingScheduleRequest], Field(min_length=1, max_length=10)]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "edits": [UpdatePricingScheduleRequest.from_dict(_item) for _item in obj["edits"]] if obj.get("edits") is not None else None
        })
        return _obj

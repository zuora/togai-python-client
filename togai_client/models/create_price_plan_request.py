...
class CreatePricePlanRequest(BaseModel):
    """
    ...
    price_plan_details: CreatePricePlanDetails = Field(alias="pricePlanDetails")
    pricing_rules: Optional[List[CreatePricingRule]] = Field(default=None, alias="pricingRules")
    __properties: ClassVar[List[str]] = ["name", "description", "type", "pricePlanDetails", "pricingRules"]

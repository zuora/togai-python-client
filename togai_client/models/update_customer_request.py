...
class UpdateCustomerRequest(BaseModel):
    ...
    """ # noqa: E501
    name: Optional[Annotated[str, Field(min_length=3, strict=True, max_length=255)]] = Field(default=None, description="Name of the Customer")
    ...
    __properties: ClassVar[List[str]] = ["name", "primaryEmail", "address"]

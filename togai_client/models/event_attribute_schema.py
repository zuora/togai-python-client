...
class EventAttributeSchema(BaseModel):
    ...
    """ # noqa: E501
    name: Annotated[str, Field(strict=True, max_length=50)] = Field(description="Name of the event attribute.")
    default_unit: Optional[Annotated[str, Field(strict=True, max_length=10)]] = Field(default=None, description="Unit for the attribute", alias="defaultUnit")
    __properties: ClassVar[List[str]] = ["name", "defaultUnit"]

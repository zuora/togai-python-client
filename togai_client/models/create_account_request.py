...
class CreateAccountRequest(BaseModel):
    ...
    customer_id: Annotated[str, Field(min_length=1, strict=True, max_length=255)] = Field(description="Customer Identifier for whom the account is being created", alias="customerId")
    __properties: ClassVar[List[str]] = ["id", "name", "invoiceCurrency", "aliases", "accountAliases", "address", "primaryEmail", "billingInformation", "settings", "netTermDays", "metadata", "tags", "status", "customerId"]

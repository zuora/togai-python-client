...
class QueryInputSortInner(BaseModel):
    """
    QueryInputSortInner
    """ # noqa: E501
    column: QueryColumn
    sort_order: StrictStr = Field(alias="sortOrder")
    __properties: ClassVar[List[str]] = ["column", "sortOrder"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "column": QueryColumn.from_dict(obj["column"]) if obj.get("column") is not None else None,

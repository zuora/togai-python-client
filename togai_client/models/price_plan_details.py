...
class PricePlanDetails(BaseModel):
    """
    PricePlanDetails
    """ # noqa: E501
    supported_currencies: List[StrictStr] = Field(alias="supportedCurrencies")
    active_currencies: List[StrictStr] = Field(alias="activeCurrencies")
    ...
    type: Optional[PricePlanType] = None
    deferred_revenue: Optional[StrictBool] = Field(default=None, alias="deferredRevenue")
    allow_ongoing_cycle_updates: Optional[Any] = Field(default=None, description="Allow changes to price plan from the beginning of the ongoing cycle. type: boolean ")
    __properties: ClassVar[List[str]] = ["supportedCurrencies", "activeCurrencies", "pricingCycleConfig", "usageRateCards", "fixedFeeRateCards", "licenseRateCards", "billingEntitlementRateCards", "entitlementOverageRateCards", "minimumCommitment", "creditGrantRateCards", "type", "deferredRevenue", "allow_ongoing_cycle_updates"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        # set to None if allow_ongoing_cycle_updates (nullable) is None
        # and model_fields_set contains the field
        if self.allow_ongoing_cycle_updates is None and "allow_ongoing_cycle_updates" in self.model_fields_set:
            _dict['allow_ongoing_cycle_updates'] = None

...
class PricingRuleAction(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["type", "target", "id", "description", "metadata"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['ADD', 'UPDATE']):
            raise ValueError("must be one of enum values ('ADD', 'UPDATE')")
        return value

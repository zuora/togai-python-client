...
class EventSchema(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["name", "description", "version", "status", "attributes", "dimensions", "filterFields", "featureDetails", "enrichments", "eventIdTemplate", "eventLevelRevenue", "createdAt", "updatedAt"]

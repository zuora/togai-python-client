...
class CustomInvoiceLineItem(BaseModel):
    """
    ...
    billable_id: Optional[StrictStr] = Field(default=None, alias="billableId")
    __properties: ClassVar[List[str]] = ["id", "description", "valuePerQuantity", "quantity", "value", "billableId"]

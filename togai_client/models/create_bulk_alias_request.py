...
class CreateBulkAliasRequest(BaseModel):
    """
    Create bulk alias
    """ # noqa: E501
    aliases: Annotated[List[CreateAliasRequest], Field(min_length=1, max_length=100)]
    __properties: ClassVar[List[str]] = ["aliases"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "aliases": [CreateAliasRequest.from_dict(_item) for _item in obj["aliases"]] if obj.get("aliases") is not None else None
        })
        return _obj

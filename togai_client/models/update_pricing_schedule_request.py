...
class UpdatePricingScheduleRequest(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["mode", "pricePlanId", "effectiveFrom", "effectiveUntil", "pricePlanDetailsOverride", "pricingRulesOverride", "retainStartOffsets"]

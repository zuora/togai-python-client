...
class EventsCorrectionResponse(BaseModel):
    """
    Events Correction response
    """ # noqa: E501
    data: Annotated[List[EventCorrectionInfo], Field(min_length=1, max_length=50)]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [EventCorrectionInfo.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
        return _obj

...
class PricePlanDetailsOverride(BaseModel):
    """
    ...
    fixed_fee_rate_cards: Optional[Annotated[List[FixedFeeRateCard], Field(min_length=1)]] = Field(default=None, alias="fixedFeeRateCards")

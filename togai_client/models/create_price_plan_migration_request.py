...
class CreatePricePlanMigrationRequest(BaseModel):
    """
    ...
    require_confirmation: Optional[StrictBool] = Field(default=None, description="This field specifies whether to process job or to wait till the job is confirmed. Default value: false ", alias="requireConfirmation")
    __properties: ClassVar[List[str]] = ["sourceId", "sourceVersion", "targetId", "targetVersion", "migrationMode", "retainStartOffsets", "isPricePlanV2Migration", "requireConfirmation"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "requireConfirmation": obj.get("requireConfirmation")
        })
        return _obj

...
class EntitlementOverageEntry(BaseModel):
    """
    EntitlementOverageEntry
    """ # noqa: E501
    feature_id: Annotated[str, Field(min_length=1, strict=True)] = Field(alias="featureId")
    quantity: Union[StrictFloat, StrictInt]
    __properties: ClassVar[List[str]] = ["featureId", "quantity"]

...
class CreateProposalRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["pricePlanId", "quantity", "rateCardQuantities", "idempotencyKey", "purchasePlanOverride", "associationOverride", "walletTopupDetails", "effectiveFrom", "effectiveUntil", "expiryDate", "type", "paymentMode"]

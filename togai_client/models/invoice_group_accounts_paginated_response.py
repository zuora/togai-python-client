...
class InvoiceGroupAccountsPaginatedResponse(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "email", "dailyInvoiceConsolidation", "netTermDays", "invoiceCurrency", "billingAddress", "accountsCount", "createdAt", "updatedAt", "accounts", "nextToken"]

...
class CreatePricePlanV2Request(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["name", "description", "type", "pricingCycleConfig", "supportedCurrencies", "deferredRevenue", "allowOngoingCycleUpdates"]

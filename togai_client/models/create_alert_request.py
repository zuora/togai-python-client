...
class CreateAlertRequest(BaseModel):
    ...
    CreateAlertRequest
    """ # noqa: E501
    alert_template_id: StrictStr = Field(alias="alertTemplateId")
    interval: StrictInt
    ...
    status: AlertStatus
    __properties: ClassVar[List[str]] = ["alertTemplateId", "interval", "validity", "description", "entityDetails", "ownerDetails", "parameters", "status"]

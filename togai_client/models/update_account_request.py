...
class UpdateAccountRequest(BaseModel):
    ...
    """ # noqa: E501
    name: Optional[Annotated[str, Field(min_length=3, strict=True, max_length=255)]] = Field(default=None, description="Name of the Account")
    ...
    metadata: Optional[Dict[str, StrictStr]] = Field(default=None, description="Additional information associated with the account. Example: GSTN, VATN NOTE: This replaces the existing metadata if the metadata in the request is not null.  To remove all existing metadata, use empty object ")
    tags: Optional[List[StrictStr]] = Field(default=None, description="Tag for accounts are stored in lowercase")
    __properties: ClassVar[List[str]] = ["name", "status", "invoiceCurrency", "netTermDays", "primaryEmail", "billingInformation", "address", "metadata", "tags"]

...
class EventPipelineInfoPricePlans(BaseModel):
    """
    ...
    usage_meters: Optional[List[StrictStr]] = Field(default=None, alias="usageMeters")
    __properties: ClassVar[List[str]] = ["name", "id", "scheduleId", "cycleStart", "cycleEnd", "usageMeters"]

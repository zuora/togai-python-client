...
class QueryColumn(BaseModel):
    ...
    functions: Optional[List[QueryFunction]] = None
    aggregator: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["dataSource", "columnName", "alias", "functions", "aggregator"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "alias": obj.get("alias"),
            "functions": [QueryFunction.from_dict(_item) for _item in obj["functions"]] if obj.get("functions") is not None else None,

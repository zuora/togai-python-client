...
class PricingScheduleWithPricePlanId(BaseModel):
    """
    ...
    price_plan_info: Optional[PricePlanInfo] = Field(default=None, alias="pricePlanInfo")
    __properties: ClassVar[List[str]] = ["id", "pricePlanDetails", "startDate", "endDate", "version", "pricingRules", "isOverriden", "pricePlanId", "pricePlanName", "pricePlanInfo"]

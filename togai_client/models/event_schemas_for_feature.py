...
class EventSchemasForFeature(BaseModel):
    """
    event_schema details that are in association with feature
    """ # noqa: E501
    schema_name: Annotated[str, Field(strict=True)] = Field(alias="schemaName")
    attribute_name: StrictStr = Field(alias="attributeName")
    __properties: ClassVar[List[str]] = ["schemaName", "attributeName"]

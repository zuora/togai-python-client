...
class NamedLicenseUpdate(BaseModel):
    """
    ...
    effective_until: Optional[datetime] = Field(default=None, alias="effectiveUntil")
    created_at: datetime = Field(alias="createdAt")
    updated_at: datetime = Field(alias="updatedAt")
    __properties: ClassVar[List[str]] = ["id", "licenseId", "accountId", "name", "effectiveFrom", "effectiveUntil", "createdAt", "updatedAt"]

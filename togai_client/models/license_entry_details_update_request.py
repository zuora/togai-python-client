...
class LicenseEntryDetailsUpdateRequest(BaseModel):
    """
    ...
    effective_from: datetime = Field(description="The effective from date of the license entry", alias="effectiveFrom")
    metadata: Dict[str, StrictStr]
    __properties: ClassVar[List[str]] = ["accountId", "effectiveFrom", "metadata"]

...
class CreateInvoiceGroupRequest(BaseModel):
    """
    ...
    account_ids: Annotated[List[StrictStr], Field(min_length=1, max_length=100)] = Field(alias="accountIds")
    net_term_days: Optional[StrictInt] = Field(default=None, alias="netTermDays")
    address: Address
    __properties: ClassVar[List[str]] = ["name", "email", "dailyInvoiceConsolidation", "accountIds", "netTermDays", "address"]

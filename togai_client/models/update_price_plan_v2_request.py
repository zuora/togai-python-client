...
class UpdatePricePlanV2Request(BaseModel):
    """
    ...
    supported_currencies: Optional[List[StrictStr]] = Field(default=None, description="List of currencies supported by the price plan", alias="supportedCurrencies")
    __properties: ClassVar[List[str]] = ["description", "pricingCycleConfig", "supportedCurrencies"]

...
class CreatePricingRule(BaseModel):
    """
    CreatePricingRule
    """ # noqa: E501
    name: StrictStr = Field(description="Name of the pricing rule")
    order: StrictInt = Field(description="Order of the pricing rule")
    ...
    __properties: ClassVar[List[str]] = ["name", "order", "invoiceTiming", "condition", "computation", "action"]

...
class SettingPaginatedResponse(BaseModel):
    """
    SettingPaginatedResponse
    """ # noqa: E501
    data: Optional[List[Setting]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [Setting.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,

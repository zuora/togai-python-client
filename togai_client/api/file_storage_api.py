...
class FileStorageApi:
    ...
    @validate_call
    def get_download_url_with_http_info(
        self,
        file_id: StrictStr,
        expiry: Optional[StrictInt] = None,
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[FileDownloadUrlResponse]:
        """Get a download url for a file
    ...
    @validate_call
    def get_download_url_without_preload_content(
        self,
        file_id: StrictStr,
        expiry: Optional[StrictInt] = None,
        _request_timeout: Union[
    ...
    def _get_download_url_serialize(
        ...
        if expiry is not None:
            ...
            _query_params.append(('expiry', expiry))
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/files/{file_id}/download_url',

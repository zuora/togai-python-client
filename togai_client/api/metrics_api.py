...
class MetricsApi:
    ...
    def get_metrics(
        self,
        get_metrics_request: Optional[GetMetricsRequest] = None,
        ...
        :param get_metrics_request:
        :type get_metrics_request: GetMetricsRequest
    ...
    def _get_metrics_serialize(
        ...
        if get_metrics_request is not None:
            _body_params = get_metrics_request
